 ...
 */
public class TransportTypeTrafficVolumeReportTestSteps {
    ...
    @Step
    public void getTransportTypeTrafficVolumeReport() throws TestInitializationException, ValidationException {

        GenericResponse result = client.getTransportTypeTrafficVolumeReport(TestData.get(TestDataKey.TRANSPORT_TYPE.getValue(), String.class),
    ...
    @Step
    public void getTransportTypeTrafficVolumeReportInterval() throws TestInitializationException, ValidationException {
    ...
    public void getTransportTypeTrafficVolumeReportOneDayTimeRange() throws TestInitializationException, ValidationException {
        ...
        GenericResponse resultDef = client.getTransportTypeTrafficVolumeReport(TestData.get(TestDataKey.TRANSPORT_TYPE.getValue(), String.class),
                dateFrom,
                TestData.get(TestDataKey.DATE_TO.getValue(), Date.class));
        ResponseValidator.validateResponse(resultDef);
        GenericResponse resultInter = client.getTransportTypeTrafficVolumeReport(TestData.get(TestDataKey.TRANSPORT_TYPE.getValue(), String.class),
                dateFrom,
                TestData.get(TestDataKey.DATE_TO.getValue(), Date.class),
                TestData.get(TestDataKey.INTERVAL.getValue(), String.class));
    ...
    @Step
    public void getTransportTypeTrafficVolumeReportOneWeekTimeRange() throws TestInitializationException, ValidationException {
    ...
    @Step
    public void getTransportTypeTrafficVolumeReportOneMonthTimeRange() throws TestInitializationException, ValidationException {
    ...
    @Step
    public void getTransportTypeTrafficVolumeReportMoreThanMonthTimeRange() throws TestInitializationException, ValidationException {
