 ...
 */
public class ModifyTransportConfigurationSteps {
    ...
    public void checkParameter(String transportId, String xmlParameter, String xml,String parameter) throws Exception {
        ...
        //update transport
        try {
            GenericResponse modifyResponse = client.modifyTransportConfiguration(transportId, xml);
    ...
    @Step
    public void checkErrorForInvalidSpeedLimit(String transportId, String xml) throws Exception {

        GenericResponse modifyResponse = client.modifyTransportConfiguration(transportId, xml);
        Assert.assertTrue("Error was not received", modifyResponse.getXmlResult().contains("The speedLimit parameter value is invalid."));
        }

    @Step
    public void checkErrorForInvalidTransportStrategy(String transportId, String xml) throws Exception {

        GenericResponse modifyResponse = client.modifyTransportConfiguration(transportId, xml);
        Assert.assertTrue("Invalid error-message", modifyResponse.getXmlResult().contains("The strategy parameter value is invalid."));
    }
